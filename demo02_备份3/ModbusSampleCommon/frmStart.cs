...
namespace Modbus
{
    public class frmStart : System.Windows.Forms.Form
    {
        ...
        private void button4_Click(object sender, EventArgs e)//开始运行按钮
        {
            ...
            text=usartButton_Click(sender,e);//调用打开串口按钮
        ...
        private String UsartButton_Click(object sender, EventArgs e)//打开串口按钮
        {
        ...
        private void sendButton_Click(object sender, EventArgs e)//串口发送数据
        {
